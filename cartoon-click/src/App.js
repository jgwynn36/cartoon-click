...
class App extends Component {
  ...
  clickCartoon = id => { 
    const shuffle = this.shuffle(cartoons); 
    ...
    render() {
      ...
      //   <div className="App"></div>
          ...
          {/* <h3 className="App-Intro">
            <strong>Click on an image to receive point, but do not click it twice or you will lose</strong>
        ...
        <div className="container">
          <span className="text-muted">J Gwynn Cartoon Clicky Game - React app - &copy; 2019</span>
        </div>
      </footer>
        </div> */}
      {/* );
